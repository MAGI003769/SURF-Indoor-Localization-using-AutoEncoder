...
test_dataset = pd.read_csv("test_set.csv",header = 0)
...
'''
dnn_weights_h3 = weight_variable([n_hidden_2, n_hidden_1])
dnn_biases_h3 = bias_variable([n_hidden_1])
'''
...
with tf.Session() as session:
    ...
    #plot3, = plt.plot(plot_epoch, plot_val_acc, '-k')
    plt.title('Accuracy')
    plt.xlabel('Epoch')
